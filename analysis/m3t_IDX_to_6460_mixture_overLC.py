...
filt.to_csv("../data/IDX/target_transitions_to_learn_conv_6460.csv",index=False)
...
targets.to_csv("../data/IDX/targets_for_evaluation_6460.csv",index=False)
...
if __name__ == "__main__":
    ...
    # output SRM file
    srm_table.to_csv("../data/IDX/generated_SRM_table_6460.csv")

    # plot breakdown curves
    plotBreakdownCurves(breakdownCurves,"../data/IDX/breakdown_curves_6460.pdf")